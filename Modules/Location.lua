...
function MS:CreateLocation()
    ...
    LocationFrame.Text:SetPoint(DB.Layout[1], LocationFrame, DB.Layout[2], 0, 0)
    LocationFrame.Text:SetJustifyH(MS:SetJustification(DB.Layout[1]))
    LocationFrame:SetWidth(LocationFrame.Text:GetWidth())
    LocationFrame:SetHeight(LocationFrame.Text:GetHeight())
    if DB.Enable then
        LocationFrame:Show()
...
function MS:UpdateLocation()
    ...
    if MS.LocationFrame then
        ...
        MS.LocationFrame.Text:SetPoint(DB.Layout[1], MS.LocationFrame, DB.Layout[2], 0, 0)
        ...
        if DB.Enable then
            ...
            MS.LocationFrame:SetWidth(MS.LocationFrame.Text:GetWidth())
            MS.LocationFrame:SetHeight(MS.LocationFrame.Text:GetHeight())
        else
