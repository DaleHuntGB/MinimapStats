...
local function FetchDate()
	local dateString = date(MS.db.global.Date.Format)
...
function MS:CreateDate()
	...
	if DB.Enable then
		...
		DateFrame:RegisterEvent("CALENDAR_UPDATE_EVENT_LIST")
		...
		DateFrame:UnregisterEvent("CALENDAR_UPDATE_EVENT_LIST")
...
function MS:UpdateDate()
	...
	if MS.DateFrame then
		...
		if DB.Enable then
			...
			MS.DateFrame:RegisterEvent("CALENDAR_UPDATE_EVENT_LIST")
			...
			MS.DateFrame:UnregisterEvent("CALENDAR_UPDATE_EVENT_LIST")
