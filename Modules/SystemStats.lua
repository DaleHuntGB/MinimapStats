...
function MS:CreateSystemStats()
    ...
    SystemStatsFrame.Text:SetPoint(DB.Layout[1], SystemStatsFrame, DB.Layout[2], 0, 0)
...
function MS:UpdateSystemStats()
    ...
    if MS.SystemStatsFrame then
        ...
        MS.SystemStatsFrame.Text:SetPoint(DB.Layout[1], MS.SystemStatsFrame, DB.Layout[2], 0, 0)
