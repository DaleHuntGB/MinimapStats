...
function MS:CreateGUI()
    ...
    local function DrawTooltipContainer(MSGUI_Container)
        ...
        TooltipDisplayPlayerKeystoneCheckbox:SetRelativeWidth(0.33)
        ...
        TooltipDisplayPartyKeystoneCheckbox:SetRelativeWidth(0.33)
        ...
        TooltipDisplayAffixesDescCheckbox:SetRelativeWidth(0.33)

        local TooltipDisplayAffixesThresholdCheckbox = MSGUI:Create("CheckBox")
        TooltipDisplayAffixesThresholdCheckbox:SetLabel("Display Affix Thresholds")
        TooltipDisplayAffixesThresholdCheckbox:SetValue(MS.DB.global.DisplayAffixThresholds)
        TooltipDisplayAffixesThresholdCheckbox:SetDisabled(not MS.DB.global.ShowTooltip or not MS.DB.global.DisplayAffixes or not MS.DB.global.ShowSystemsStatsFrame)
        TooltipDisplayAffixesThresholdCheckbox:SetCallback("OnValueChanged", function(_, _, Value) MS.DB.global.DisplayAffixThresholds = Value end)
        TooltipDisplayAffixesThresholdCheckbox:SetRelativeWidth(0.33)
        ...
        TooltipDisplayAffixesCheckbox:SetCallback("OnValueChanged", function(_, _, Value) MS.DB.global.DisplayAffixes = Value
            ...
            TooltipDisplayAffixesThresholdCheckbox:SetDisabled(not MS.DB.global.DisplayAffixes)
        end)
        TooltipDisplayAffixesCheckbox:SetRelativeWidth(0.33)
        ...
        ShowTooltipFrameCheckBox:SetCallback("OnValueChanged", 
            ...
            if not MS.DB.global.ShowTooltip then
                ...
                TooltipDisplayAffixesThresholdCheckbox:SetDisabled(true)
        ...
        MythicPlusOptionsContainer:AddChild(TooltipDisplayAffixesThresholdCheckbox)
