...
function MS:CreateGUI()
    ...
    local function DrawLocationContainer(MSGUI_Container)
        ...
        LocationColourColourPicker:SetRelativeWidth(0.25)
        ...
        LocationOnMouseoverCheckBox:SetCallback("OnValueChanged",
            function(_, _, Value) MS.DB.global.LocationOnMouseover = Value
            MS:UpdateLocationFrame()
        end)
        LocationOnMouseoverCheckBox:SetRelativeWidth(0.25)
        ...
        LocationFontSizeSlider:SetRelativeWidth(0.25)
        ...
        ShowLocationFrameCheckBox:SetCallback("OnValueChanged", 
            ...
            if not MS.DB.global.ShowLocationFrame then
                ...
                LocationOnMouseoverCheckBox:SetDisabled(true)
            else
                ...
                LocationOnMouseoverCheckBox:SetDisabled(false)
            end
        end)

        MSGUI_Container:AddChild(ShowLocationFrameCheckBox)
        MSGUI_Container:AddChild(LocationOptionsContainer)
        LocationOptionsContainer:AddChild(LocationOnMouseoverCheckBox)
    ...
    local function DrawTooltipContainer(MSGUI_Container)
        ...
        TooltipDisplayPlayerKeystoneCheckbox:SetRelativeWidth(0.25)
        ...
        local TooltipDisplayDelveSlotsCheckbox = MSGUI:Create("CheckBox")
        TooltipDisplayDelveSlotsCheckbox:SetLabel("Display Delve Slots")
        TooltipDisplayDelveSlotsCheckbox:SetValue(MS.DB.global.DisplayDelveSlots)
        TooltipDisplayDelveSlotsCheckbox:SetDisabled(not MS.DB.global.ShowTooltip or not MS.DB.global.ShowSystemsStatsFrame or MS.BUILDVERSION <= 110000 or not MS.DB.global.DisplayVaultOptions)
        TooltipDisplayDelveSlotsCheckbox:SetCallback("OnValueChanged", function(_, _, Value) MS.DB.global.DisplayDelveSlots = Value end)
        TooltipDisplayDelveSlotsCheckbox:SetRelativeWidth(0.25)
        ...
        GreatVaultOptionsContainer:AddChild(TooltipDisplayDelveSlotsCheckbox)
