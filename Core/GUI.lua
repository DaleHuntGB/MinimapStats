...
function MS:CreateGUI(TabToOpen)
    ...
    function MS:CreateGeneralOptions(Container)
        ...
        DisplayLoginMessageToggle:SetValue(DB.General.DisplayLoginMessage)
        DisplayLoginMessageToggle:SetRelativeWidth(0.5)
        DisplayLoginMessageToggle:SetCallback("OnValueChanged", function(_, _, value) DB.General.DisplayLoginMessage = value end)
        GlobalContainer:AddChild(DisplayLoginMessageToggle)
    ...
    function MS:CreateTimeOptions(Container)
        ...
        TimeFormatDropdown:SetList({ ["12H"] = "12-Hour", ["24H"] = "24-Hour", ["12H_NO_ZERO"] = "12-Hour (No Leading Zero)"})
    ...
    function MS:CreateTooltipOptions(Container)
        ...
        ShowEventsInTooltip:SetCallback("OnValueChanged", function(_, _, value) DB.Tooltip.Time.Events = value end)
