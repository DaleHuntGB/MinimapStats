...
function MS:CreateGUI()
    ...
    local function DrawTooltipContainer(MSGUI_Container)
        ...
        TooltipAnchorFromPosition:SetLabel("Anchor From")
        ...
        TooltipAnchorToPosition:SetLabel("Anchor To")
        ...
        local TooltipTextureIconSizeSlider = MSGUI:Create("Slider")
        TooltipTextureIconSizeSlider:SetLabel("Texture Icon Size")
        TooltipTextureIconSizeSlider:SetValue(MS.DB.global.TooltipTextureIconSize)
        TooltipTextureIconSizeSlider:SetDisabled(not MS.DB.global.ShowTooltip)
        TooltipTextureIconSizeSlider:SetSliderValues(8, 32, 1)
        TooltipTextureIconSizeSlider:SetCallback("OnValueChanged", function(_, _, Value) MS.DB.global.TooltipTextureIconSize = Value end)
        TooltipTextureIconSizeSlider:SetCallback("OnEnter", function()
            GameTooltip:SetOwner(TooltipTextureIconSizeSlider.frame, "ANCHOR_NONE")
            GameTooltip:SetPoint("TOPRIGHT", TooltipTextureIconSizeSlider.frame, "BOTTOMRIGHT", 0, -1)
            GameTooltip:SetText("Sets the size of the texture icons used for Keystone / Affix Icons.")
            GameTooltip:Show()
        end)
        TooltipTextureIconSizeSlider:SetCallback("OnLeave", function() GameTooltip:Hide() end)
        TooltipTextureIconSizeSlider:SetRelativeWidth(0.5)
        ...
        ShowTooltipFrameCheckBox:SetCallback("OnValueChanged", 
            ...
            if not MS.DB.global.ShowTooltip then
                ...
                TooltipDisplayFriendsListCheckbox:SetDisabled(true)
                ...
                TooltipTextureIconSizeSlider:SetDisabled(true)
            else
                ...
                TooltipDisplayFriendsListCheckbox:SetDisabled(false)
                ...
                TooltipTextureIconSizeSlider:SetDisabled(false)
            end
        end)
        ...
        MythicPlusOptionsContainer:AddChild(TooltipTextureIconSizeSlider)
        MSGUI_Container:AddChild(PositionOptionsContainer)
    ...
    local GUIContainerTabGroup = MSGUI:Create("TabGroup")
